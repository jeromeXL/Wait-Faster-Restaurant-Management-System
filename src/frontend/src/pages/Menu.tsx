...
const Menu = () => {
    const menu = {
        categories: [
            {
                name: "Featured Items",
                items: ["id_two", "id_four", "id_six", "id_eight"],
            },
            {
                name: "Starters",
                items: ["id_one", "id_two", "id_three", "id_four", "id_five"],
            },
            {
                name: "Main",
                items: ["id_six", "id_seven"],
            },
            {
                name: "Dessert",
                items: ["id_eight", "id_nine"],
            },
            {
                name: "Beverages",
                items: ["id_ten", "id_eleven"],
            },
        ],
    };
    ...
    const menuItems: Record<string, MenuItem> = {
        id_one: {
            ...
            description:
                "A combination of bread with fresh parsley, parmesan cheese and garlic",
            image: Item_one,
        },
        id_two: {
            name: "Bruschetta",
            ...
            dietary_details: [DietaryDetail.VEGETARIAN],
            description:
                "Sourdough topped with freshly diced tomato with garlic, olive oil, oregano and basil",
            image: Item_two,
        },
        id_three: {
            name: "Cheese Stick",
            description:
                "Deep fried batter with creamy and stretchy mozarella cheese within",
            dietary_details: [DietaryDetail.VEGETARIAN],
            price: 9.0,
            image: Item_three,
        },
        id_four: {
            ...
            description:
                "Salted and pepper calamariwith parmesan aioli sauce and lemon",
            dietary_details: [],
            price: 9.0,
            image: Item_four,
        },
        id_five: {
            ...
            dietary_details: [],
            description:
                "Wedges made from sweet potatoes that are crispy on the outside, soft and caramelised inside and coated with sweet and spicy flavours",
            image: Item_five,
        },
        id_six: {
            ...
            description:
                "Sphaghetti with bacon, onions, egg and parmesan cheese",
            image: Item_six,
        },
        id_seven: {
        ...
        id_eight: {
            ...
            price: 10.0,
            dietary_details: [
                DietaryDetail.CONTAINS_EGGS,
                DietaryDetail.VEGETARIAN,
            ],
            description:
                "Velvety melange of savoiarddi cookies dipped in an espresso, layered with delicately sweetened whipped eggs and mascarpone cheese",
            image: Item_eight,
        },
        id_nine: {
            ...
            description:
                "Fresh lemon juice and lemon zest filling with billows of bakedd meringue on top for a deliciously dreamy dessert",
            image: Item_nine,
        },
        id_ten: {
            name: "Apple Juice",
