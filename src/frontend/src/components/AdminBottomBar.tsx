...
const AdminBottomBar = ({ handleOpen }: any) => {
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 flex justify-center items-center pb-4">
      ...
      >
        <div className="flex items-center justify-center gap-2 p-4 hover:bg-gray-100 text-black transition-colors" onClick={handleOpen}>
